//
//  AppliAgencesNettyAppDelegate.m
//  AppliAgencesNetty
//
...
@implementation AppliAgencesNettyAppDelegate
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
	...
	NSString *storePath = [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"AppliAgencesNetty.sqlite"];
	...
	defaultStorePath = [[NSBundle mainBundle] pathForResource:@"AppliAgencesNetty" ofType:@"sqlite"];
